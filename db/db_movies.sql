...
CREATE TABLE IF NOT EXISTS `tbl_user` (
  ...
  `new` varchar(5) NOT NULL DEFAULT 'yes',
  PRIMARY KEY (`user_id`)
...
INSERT INTO `tbl_user` (`user_id`, `user_fname`, `user_name`, `user_pass`, `user_email`, `user_date`, `user_level`, `user_ip`, `new`) VALUES
(1, 'Steven', 'scadick2', 'Sjc112791!', 'steven.cadick@gmail.com', '2018-02-15 13:33:23', '', '::1', ''),
(5, 'goose', 'goose', 'goose', 'goose@goose.goose', '2018-02-15 14:37:05', '2', '::1', ''),
(6, 'jertz', 'jertz', '8y9zEis0ru', 'jertz@jerzz.com', '2018-02-22 03:39:38', '1', 'no', ''),
(7, 'chad', 'chadinson', 'tJNRf6KtHb', 'chad@chadchadison.com', '2018-02-22 04:08:02', '1', 'no', ''),
(8, 'bob', 'bob', 'bob', 'bob@bob.com', '2018-03-01 03:48:51', '2', 'no', 'yes'),
(9, 'jed', 'jed', 'jed', 'jed', '2018-03-01 03:50:03', '1', 'no', 'yes');
COMMIT;
